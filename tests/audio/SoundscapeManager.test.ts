...
describe('SoundscapeManager', () => {
  ...
  test('should adjust layers based on signal strength', () => {
    // Initialize the manager
    soundscapeManager.initialize();
    
    // Adjust layers with different signal strengths
    soundscapeManager.adjustLayers(0);   // No signal
    soundscapeManager.adjustLayers(0.5); // Medium signal
    soundscapeManager.adjustLayers(1);   // Perfect signal
  ...
  test('should handle operations when not initialized', () => {
    // Try to adjust layers without initializing
    soundscapeManager.adjustLayers(0.5);
