...
namespace SignalLost
{
    ...
    public partial class UIVisualizer : Node
    {
        ...
        public static void VisualizeUI(Control control)
        {
            ...
            // If this is a PixelUIDemo, visualize its specific elements
            if (control is PixelUIDemo pixelUI)
            {
        ...
        // Visualize PixelUIDemo specific elements
        private static void VisualizePixelUI(PixelUIDemo pixelUI, char[,] grid, Vector2 windowSize)
        {
