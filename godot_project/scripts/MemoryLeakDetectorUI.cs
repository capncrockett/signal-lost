...
namespace SignalLost
{
    ...
    public partial class MemoryLeakDetectorUI : Control
    {
        ...
        private void OnMemorySnapshotTaken(Godot.Collections.Dictionary snapshot)
        {
            UpdateUI();
        }
        ...
        private void UpdateUI()
        {
            ...
            // Update object count
            int objectCount = GC.GetTotalMemory(false) > 0 ? Engine.GetProcessFrames() : 0;
        ...
        private void UpdateObjectList()
        {
            ...
            objectCounts["Process Frames"] = Engine.GetProcessFrames();
