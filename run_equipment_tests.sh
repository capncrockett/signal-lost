...
# This script runs the Equipment System tests
...
# Run the tests
echo "Running Equipment System tests..."
"$GODOT" --path godot_project --script res://tests/equipment/EquipmentSystemTest.cs
